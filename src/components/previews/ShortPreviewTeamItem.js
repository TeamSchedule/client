...
function ShortPreviewTeamItem({ className, description, imgSrc, teamName, linkTo, teamColor }) {
    return (
        <Link to={linkTo} className={`shortPreviewTeamItem ${className}`}>
            <div className="p-4">
                <TeamAvatar imgSrc={imgSrc} size={80} className="m-auto" teamColor={teamColor} />
